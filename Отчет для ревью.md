...
- В текущей ревизии дополнительно вручную вычищены responsive-регрессии радио: карусели, счетчики/чипы, badge, mobile-блок `Сейчас играет`, контрастный режим и длинные секции.
...
Это обеспечивает согласованность API-контрактов для фронтенда, ручного тестирования и external QA. Актуальная версия спецификации: `1.4.0`. Генерация спеки и доступность Swagger UI дополнительно проверяются `SwaggerDocumentationFeatureTest`.
