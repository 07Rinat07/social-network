export const RADIO_PRESET_CATALOG = [
    ...
    },
    {
        ...
        shortLabel: 'US',
        category: 'dance',
        hint: 'Electro house канал Digitally Imported.',
        query: 'DI.FM Electro House',
        country: 'United States',
        language: 'English',
        tag: 'electro house',
        keywords: ['digitally imported electro house', 'di.fm electro house'],
    ...
    },
    {
        ...
        shortLabel: 'US',
        category: 'dance',
        hint: 'Trance канал Digitally Imported.',
        query: 'DI.FM Trance',
        country: 'United States',
        language: 'English',
        tag: 'trance',
        keywords: ['digitally imported trance', 'di.fm trance'],
        homepage: 'https://www.di.fm/',
    },
    {
        id: 'record-trance',
    ...
    },
    {
        ...
        shortLabel: 'RU',
        category: 'dance',
        hint: 'House-станция экосистемы Record.',
        query: 'Radio Record House',
        country: 'Russia',
        language: 'Russian',
        tag: 'house',
        keywords: ['record house', 'радио рекорд хаус'],
        homepage: 'https://radiorecord.ru/station/house/',
    },
    {
        id: 'record-techno',
        name: 'Record Techno',
    ...
    },
    {
        ...
        shortLabel: 'UK',
        category: 'rock_jazz',
        hint: 'Классический и современный рок.',
        query: 'Planet Rock',
        country: 'United Kingdom',
        language: 'English',
        tag: 'rock',
        keywords: ['planet rock'],
        homepage: 'https://planetradio.co.uk/planet-rock/',
    },
